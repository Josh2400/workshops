...
```{r}
#| label: tbl-tate-medium-dummy-extract
#| echo: false
medium_examples |>
  recipe() |>
...
```{r}
#| label: tbl-better-tate-medium-dummy-extract
#| echo: false
medium_examples |>
  recipe() |>
...
```{r}
#| label: tbl-colors-dummy-extract
#| echo: false
color_examples |>
  recipe() |>
...
```{r}
#| label: tbl-lang-dummy-multi-choice
#| echo: false
recipe(~., data = values) |>
...
```{r}
#| label: tbl-medium-dummy-extract-threshold-0
#| echo: false
...
```{r}
#| label: tbl-medium-dummy-extract-threshold-0.05
#| echo: false
recipe(~ medium, data = tate_text) |>
